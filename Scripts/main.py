...
def main():
    ...
    # required_images = [
    #     "assets/image/bg/bg_beach.png ",
    #     "assets/image/bg/bg_beach2.png ",
    #     "assets/image/obj/enemy_biohazard.png ",
    #     "assets/image/obj/enemy_brokenBottle.png ",
    #     "assets/image/obj/enemy_garbage-bag.png ",
    #     "assets/image/obj/obj_crab.png ",
    #     "assets/image/obj/obj_heart.png ",
    #     "assets/image/obj/obj_shell.png ",
    #     "assets/image/obj/obj_speedUp.png"
    # ]
    ...
    #     if not os.path.exists(img.replace("assets\\image\\obj", "assets/image/obj", "assets\\image\\bg","assets/image/bg" ))
    # ]  # Fixed path handling
    # if missing_images:
    #     print("Vui lòng thêm các file ảnh sau vào thư mục Game/image:")
    #     for img in missing_images:
    #         # print(f"- {img.replace('assets\\image\\', '')}")
    #         pass
